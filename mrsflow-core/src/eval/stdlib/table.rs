...
mod tests {
    ...
    fn nested_join_then_expand_folds_to_one_select() {
        ...
        assert_eq!(
            ...
            r#"SELECT orderh.ref AS ref, orderh.custcode AS custcode, orderi.quantity AS quantity FROM orderh LEFT JOIN orderi ON orderh.ref = orderi.ref AND orderh.ref IS NOT NULL"#
        );
    }
